...
import { AdminLegalActListComponent } from './admin-legal-act-list/admin-legal-act-list.component'; // (4) Импорт
import { AdminRuleListComponent } from './admin-rule-list/admin-rule-list.component'; // (5) НОВЫЙ ИМПОРТ
...
export const routes: Routes = [
  ...
  {
    path: 'admin/legal-acts',
    component: AdminLegalActListComponent,
    canActivate: [authGuard, adminGuard],
  },
  {
    path: 'admin/rules', // (6) НОВЫЙ МАРШРУТ
    component: AdminRuleListComponent,
    canActivate: [authGuard, adminGuard],
  },
